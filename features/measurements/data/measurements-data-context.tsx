...
import { WEIGHT_PREVIEW_LIMIT, WEIGHT_TREND_LIMIT } from "@/features/measurements/constants/weight";
...
export function MeasurementsDataProvider({ children }: { children: ReactNode }) {
  ...
  const circumferenceEntries = measurementsResource.circumferences.useRecent(
    CIRCUMFERENCE_PREVIEW_LIMIT
  );
